...
여기서 하나의 프록시뿐만 아니라 여러 개의 프록시를 연결하여 체인 형태로 구성하여 여러 개의 접근 제어나 부가 기능을 추가할 수 있다.

** 본문에서 다루는 프록시와 GOF 디자인 패턴에서의 프록시라는 용어는 이름만 같으며 전혀 다른 개념이다.

## JDK 동적 프록시 / CGLIB

스프링에서 프록시 패턴을 구현하는 방법은 JDK 동적 프록시와 CGLIB가 있다.
